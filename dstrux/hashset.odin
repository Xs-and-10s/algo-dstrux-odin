...
hashset_insert :: proc(hs: ^HashSet($T), value: T) -> bool {
...
hashset_contains :: proc(hs: ^HashSet($T), value: T) -> bool {
	index := hashset_hash(hs, value)
	original_index := index
...
hashset_remove :: proc(hs: ^HashSet($T), value: T) -> bool {
	index := hashset_hash(hs, value)
	original_index := index
...
hashset_rehash :: proc(hs: ^HashSet($T)) {
